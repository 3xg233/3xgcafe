...
/// <summary>
/// 开机自启管理：HKCU\...\Run\3xgcafe-Wallpaper，指向当前运行的 exe
/// （注册表是唯一状态源，无额外偏好文件；托盘菜单勾选即同步）。
/// 旧版本的值名 WallpaperPure 会在每次读写时清理，避免新旧版本同时自启而冲突。
/// </summary>
internal static class AutoStart
{
    private const string RunKeyPath = @"Software\Microsoft\Windows\CurrentVersion\Run";
    private const string ValueName = "3xgcafe-Wallpaper";

    /// <summary>旧版本使用的注册表值名，仅用于清理。</summary>
    private const string LegacyValueName = "WallpaperPure";
